...
*TIPO*: ${packageType}\n\n
*STATUS*: ${status}\n\n
*ORIGEM*: ${cityOrigin ? cityOrigin.toUpperCase() + ' - ' : ''} ${
  stateOrigin ? stateOrigin.toUpperCase() : ''
} ${typeOrigin ? ' (' + typeOrigin + ')' : ''}\n\n
*DESTINO*: ${cityDestiny ? cityDestiny.toUpperCase() + ' - ' : ''} ${
  stateDestiny ? stateDestiny.toUpperCase() : ''
...
Ao aceitar, você concorda com a nossa Política de Privacidade e Termos de Uso, disponíveis em: ${process.env.TERMS_URL}\n\n
